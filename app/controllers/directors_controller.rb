class DirectorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @director.save
        format.html { redirect_to @director, notice: "Режиссёр был успешно создан." }
  ...
  def update
    respond_to do |format|
      if @director.update(director_params)
        format.html { redirect_to @director, notice: "Режиссёр был успешно обновлён." }
  ...
  def destroy
    @director.destroy
    respond_to do |format|
      format.html { redirect_to directors_url, notice: "Режиссёр был успешно удалён." }
  ...
  private
    ...
    def director_params
      params.require(:director).permit(:name, :second_name, :third_name, :photo)
    end
end
